  ...
  <body class="0 h-screen">
    ...
    <div class="mt-5 px-4 items-center text-center h-3/4 overflow-y-auto">
      <div class="flex flex-row ml-3 justify-center mb-2">
        ...
        <label
          for="NotesArchives"
          class="mr-8 mt-2 ml-3 rounded-3xl cursor-pointer text-sm bg-blue-500 py-1 px-4 text-white font-medium"
        >Note Archives
        </label>
        ...
        <div class="modal">
          <div class="modal-box relative h-4/6 max-w-3xl text-left">
            ...
            <div
              class="mt-1 relative overflow-y-auto shadow-sm rounded-xl mx-1 mt-8 h-4/5 max-h-4/5"
            >
              <table
